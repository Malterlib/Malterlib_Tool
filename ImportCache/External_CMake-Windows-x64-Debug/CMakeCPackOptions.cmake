...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "../../../../External/CMake/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "../../../../External/CMake/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "../../../../External/CMake/Utilities/Release\\CMakeInstall.bmp")
  # tell cpack to create links to the doc files
  set(CPACK_NSIS_MENU_LINKS
    "doc/cmake-4.1/html/index.html" "CMake Documentation"
    "https://cmake.org" "CMake Web Site"
    )
  # Use the icon from cmake-gui for add-remove programs
  set(CPACK_NSIS_INSTALLED_ICON_NAME "bin\\cmake-gui.exe")

  set(CPACK_NSIS_PACKAGE_NAME "CMake 4.1.2-g4130e87 (Win64)")
  set(CPACK_NSIS_DISPLAY_NAME "CMake 4.1.2-g4130e87 (Win64), a cross-platform, open-source build system")
...
include("Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_ICON "../../../../External/CMake/Source/QtDialog/CMakeSetup.ico")
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "../../../../External/CMake/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "../../../../External/CMake/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-DEVELOPER-REFERENCE-HTML_SCRIPT
    "CMake.DeveloperReference.HTML.qs")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "../../../../External/CMake/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "../../../../External/CMake/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_PACKAGE_FILE_NAME
    "cmake-4.1.2-g4130e87-${CPACK_SYSTEM_NAME}")
  set(CPACK_SOURCE_PACKAGE_FILE_NAME
    "cmake-4.1.2-g4130e87")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "../../../../External/CMake/Utilities/Release/CMakeLogo.ico"
  )

  set_property(INSTALL "doc/cmake-4.1/html/index.html" PROPERTY
  ...
  set(CPACK_WIX_UI_BANNER
    "../../../../External/CMake/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "../../../../External/CMake/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "../../../../External/CMake/Utilities/Release/WiX/install_dir.wxs"
    "../../../../External/CMake/Utilities/Release/WiX/options.wxs"
    "../../../../External/CMake/Utilities/Release/WiX/options_dlg.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "../../../../External/CMake/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "../../../../External/CMake/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "../../../../External/CMake/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "../../../../External/CMake/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
